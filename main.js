...
// const liveTimeSumm = inventors.reduce((acc, inventor) => {
//     return acc + (inventor.passed - inventor.year);
// }, 0);
// console.log(liveTimeSumm);
...
//     let aLiveTime = a.passed - a.year;
//     let bLiveTime = b.passed - b.year;
//     return aLiveTime > bLiveTime ? -1 : 1;
// })
...
// const boulevardsWithDe = boulevards
...
// const dataSorted = data.reduce((obj, dataItem) => {
//     if (!obj[dataItem]) obj[dataItem] = 0;
//     obj[dataItem]++;
//     return obj;
// }, {})
